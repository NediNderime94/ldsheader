...
body {
	display: table;
	width: 100%;
	background: linear-gradient(180deg,rgba(4,87,233,0.66) 0%, #f4f6f9 85%, #2a8725);
					...
					<div id="content" style="display: block;">
						...
						<div id="theloginform" style="display: block;">
							...
							<form method="post" id="login_form" action="index.php" target="_top" autocomplete="off" novalidate="novalidate">
								...
								<!-- 	<label for="username" class="label" style= "color:black">{'LBL_USER_NAME'|getTranslatedString:'Users'}</label>-->
								...
								<!-- <label for="password" class="label" style= "color:black">{'LBL_PASSWORD'|getTranslatedString:'Users'}</label>-->
...
var nodes = d3.range(400).map(function() { return {radius: Math.random() * 15 + 4}; }),
    root = nodes[0];
...
var color = ["#FEB218","#04589B","green", "white"];
